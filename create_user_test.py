...
def negative_assert_symbol(first_name):
    ...
    # Проверяется, что атрибут ответа "code" - 400
    assert user_response.json()["code"] == 400
    # Проверяется текст атрибута ответа "message"
...
def test_create_user_space_simbol_in_first_name_get_error_response():
    negative_assert_symbol("Человек и Ко")

# Тест 8. Ошибка
# Параметр fisrtName содержит спецсимволы
def test_create_user_special_simbol_in_first_name_get_error_response():
